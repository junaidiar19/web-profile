...
?>
    <aside id="fh5co-hero">
        <div class="flexslider">
            ...
            <li style="background-image: url(<?=base_url('assets/images/smp-1.jpg')?>);">
                <div class="overlay-gradient"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center slider-text">
                            <div class="slider-text-inner">
                                <h1>Tersedia Berbagai Info</h1>
                                    <h2>Kegiatan Sekolah Serta Galeri Photo SMPN 24 Banjarmasin Silahkan Jelajahi dan Cari Informasi Lengkap Terkait Sekolah Kami</h2>
                            </div>
                        </div>
                    </div>
                </div>
